...
public class TestDVD  {
	...
	public static void  main(String[] args)  {
		...
		Class interfaceDescriptor = null;//C大写
		...
		try {
			Method method = interfaceDescriptor.getMethod("getRegionCode", null);
			Class returnType = method.getReturnType();

			assertTrue("4: the return type of method getRegionCode is incorrect",
		...
		try {
			Method method = interfaceDescriptor.getMethod("getAudioTracks", null);
			Class returnType = method.getReturnType();

			assertTrue("6: the return type of method getAudioTracks is incorrect",
		...
		try {
			Method method = interfaceDescriptor.getMethod("getSubtitles", null);
			Class returnType = method.getReturnType();
