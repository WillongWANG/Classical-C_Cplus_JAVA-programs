...
public class TestVHS  {
	...
	public static void  main(String[] args)  {
		...
		try {
			Method method =	interfaceDescriptor.getMethod("getFormat", null);
			Class returnType = method.getReturnType();

			assertTrue("4: the return type of method getFormat is incorrect",
		...
		try {
			Method method = interfaceDescriptor.getMethod("getLanguage", null);
			Class returnType = method.getReturnType();

			assertTrue("6: the return type of method getLanguage is incorrect",
			           returnType.getName().equals("java.lang.String"));
