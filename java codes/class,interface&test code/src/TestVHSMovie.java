...
public class TestVHSMovie  {
	...
	public static void  main(String[] args)  {
		...
		assertTrue("3: the class should implement the interface VHS",
		           arrayInterfaces[0].getName().equals("VHS"));

		assertTrue("4: the class should extend class Movie",
		...
		VHSMovie vhsMovie = new VHSMovie(title, starring, director, format,
		                                 language);
		...
		assertTrue("7: testing method Movie.getDirector",
		...
		assertTrue("10: testing method toString",
		           vhsMovie.toString().equals(title + "," + format + ","
		                                      + language));
